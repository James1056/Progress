...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2023 at 03:41 AM
...
(15, 4, 2, 'This is for Intermediate');
...
(2, '2023-04-18 15:49:44', 'lkdjfjdafjafdsajfkjsafjsaljf;dsajflsfjd;lsaf demo 23', 'https://picsum.photos/800', 'About Our Facility'),
...
(6, '2023-04-18 15:50:16', 'demo', 'https://www.youtube.com/watch?v=IODxDxX7oi4', 'dfakfhkldem');
...
INSERT INTO `message` (`id`, `response_user_id`, `text`, `requestid`) VALUES
(2, 3, 'I love upper body dude, I can definitely help you who that ', 1),
(3, 3, 'I go to the gym Monday Wednesday Friday let me know if you go and I can lend a hand', 2),
(4, 3, 'adfsdfasdfsdfasdfadfa', 4),
(5, 3, 'dafasdfasdfasf', 1),
(6, 3, 'sdsdasdasdfasfasdf', 1);
...
(3, 2, 'looking for partner'),
(4, 3, 'sadjasdjasdajsdajsdasjdasjdasdj');
...
(19, 3, 'adsfasdfasdfdsaf', 'sdfasdfasdfasdf');
...
(8, 4, 'How to do a pushup', 1, 'IODxDxX7oi4');
